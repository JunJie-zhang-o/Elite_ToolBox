...
class FramelessWindow(QWidget):
    ...
    def titleBar_init(self):
        ...
        self.titleBar_layout=QHBoxLayout(objectName="title_layout")
        self.titleBar.raise_()
        self.titleBar_layout.setContentsMargins(0,0,0,0)
        self.titleBar_layout.addWidget(self.titleBar)
        # self.titleBar.setStyleSheet(self.qss_style("src\QSS_titlebar.qss"))
        
    
    def main_layout_init(self):
        """设置窗口的整体布局样式
        """
        self.main_layout=QVBoxLayout(self,objectName="main_layout")
        self.main_layout.setContentsMargins(0, 0, 0, 0)
        self.down_layout=QHBoxLayout(objectName="down_alyout")
        ...
        # self.down_layout.addWidget(QLabel("123"))
